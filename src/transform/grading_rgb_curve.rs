...
impl GradingRGBCurveTransform {
    ...
    pub fn style(&self) -> GradingStyle {
        let v = unsafe { ocio_sys::ocio_grading_rgb_curve_transform_get_style(self.handle.as_ptr()) };
        match v { 1 => GradingStyle::Lin, 2 => GradingStyle::Video, _ => GradingStyle::Log }
    }

    pub fn set_style(&self, style: GradingStyle) {
        unsafe { ocio_sys::ocio_grading_rgb_curve_transform_set_style(self.handle.as_ptr(), style as i32); }
    }

    pub fn num_control_points(&self, curve_type: RGBCurveType) -> i32 {
        unsafe { ocio_sys::ocio_grading_rgb_curve_transform_get_num_control_points(self.handle.as_ptr(), curve_type as i32) }
    }
    ...
    pub fn set_num_control_points(&self, curve_type: RGBCurveType, num: i32) {
        unsafe { ocio_sys::ocio_grading_rgb_curve_transform_set_num_control_points(self.handle.as_ptr(), curve_type as i32, num); }
    }
    ...
    pub fn slopes_are_default(&self, curve_type: RGBCurveType) -> bool {
        unsafe { ocio_sys::ocio_grading_rgb_curve_transform_slopes_are_default(self.handle.as_ptr(), curve_type as i32) }
    }

    pub fn bypass_lin_to_log(&self) -> bool {
        unsafe { ocio_sys::ocio_grading_rgb_curve_transform_get_bypass_lin_to_log(self.handle.as_ptr()) }
    }

    pub fn set_bypass_lin_to_log(&self, bypass: bool) {
        unsafe { ocio_sys::ocio_grading_rgb_curve_transform_set_bypass_lin_to_log(self.handle.as_ptr(), bypass); }
    }
    ...
    pub fn make_dynamic(&self) {
        unsafe { ocio_sys::ocio_grading_rgb_curve_transform_make_dynamic(self.handle.as_ptr()); }
    }

    pub fn make_non_dynamic(&self) {
        unsafe { ocio_sys::ocio_grading_rgb_curve_transform_make_non_dynamic(self.handle.as_ptr()); }
    }

    pub fn direction(&self) -> TransformDirection {
        let dir = unsafe { ocio_sys::ocio_grading_rgb_curve_transform_get_direction(self.handle.as_ptr()) };
        match dir { 1 => TransformDirection::Inverse, _ => TransformDirection::Forward }
    }

    pub fn set_direction(&self, direction: TransformDirection) {
        unsafe { ocio_sys::ocio_grading_rgb_curve_transform_set_direction(self.handle.as_ptr(), direction as i32); }
    }
}
